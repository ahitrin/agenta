...
(defn make-unit [unit-type]
  ...
  {; "static" properties (do not change during game)
   ...
   :attack-counter (ctr/make (rnd/i! (:attackSpeed unit-type)) (:attackSpeed unit-type))
   :health-counter (ctr/make (rnd/i! 100) 100)
   :speed-counter  (ctr/make (rnd/i! (:max-spd unit-type)) (:max-spd unit-type))
   :think-counter  (ctr/make (rnd/i! (:thinkSpeed unit-type)) (:thinkSpeed unit-type))
